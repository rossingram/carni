...
oh hai
bq. "OH MY ZSHELL! - IceMupppet Version"

h2. Setup

h3. The automatic installer...

@wget http://github.com/rossingram/carnivore/raw/master/tools/install.sh -O - | sh@
...
1. Clone the repository
  ...
  @git clone git://github.com/rossingram/carnivore.git ~/.oh-my-zsh@
